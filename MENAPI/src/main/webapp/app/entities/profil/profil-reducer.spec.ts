...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PROFILS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFIL actions', async () => {
      const arg = 42666;
