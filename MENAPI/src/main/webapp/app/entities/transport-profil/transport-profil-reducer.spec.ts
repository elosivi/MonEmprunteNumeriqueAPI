...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSPORTPROFIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_TRANSPORTPROFILS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSPORTPROFIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSPORTPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANSPORTPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSPORTPROFIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSPORTPROFIL actions', async () => {
      const arg = 42666;
