...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMMUNICATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMUNICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNICATION actions', async () => {
      const arg = 42666;
