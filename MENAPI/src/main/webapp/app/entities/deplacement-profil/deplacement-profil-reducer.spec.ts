...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deplacement-profil.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPLACEMENTPROFIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DEPLACEMENTPROFILS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPLACEMENTPROFIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPLACEMENTPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEPLACEMENTPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEPLACEMENTPROFIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEPLACEMENTPROFIL actions', async () => {
      const arg = 42666;
