...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESTATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRESTATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESTATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESTATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRESTATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESTATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESTATION actions', async () => {
      const arg = 42666;
