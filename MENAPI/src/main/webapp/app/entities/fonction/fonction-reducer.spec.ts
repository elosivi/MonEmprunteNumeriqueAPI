...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FONCTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_FONCTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FONCTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FONCTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FONCTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FONCTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FONCTION actions', async () => {
      const arg = 42666;
