...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_UNITES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UNITE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UNITE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UNITE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UNITE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UNITE actions', async () => {
      const arg = 42666;
