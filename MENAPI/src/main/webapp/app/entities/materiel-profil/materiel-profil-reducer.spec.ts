...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIELPROFIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MATERIELPROFILS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIELPROFIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIELPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MATERIELPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIELPROFIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATERIELPROFIL actions', async () => {
      const arg = 42666;
