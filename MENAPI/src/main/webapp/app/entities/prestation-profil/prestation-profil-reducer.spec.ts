...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prestation-profil.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESTATIONPROFIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRESTATIONPROFILS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESTATIONPROFIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESTATIONPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRESTATIONPROFIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESTATIONPROFIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESTATIONPROFIL actions', async () => {
      const arg = 42666;
