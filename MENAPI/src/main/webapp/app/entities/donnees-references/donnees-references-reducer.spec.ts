...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './donnees-references.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONNEESREFERENCES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DONNEESREFERENCES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DONNEESREFERENCES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DONNEESREFERENCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DONNEESREFERENCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DONNEESREFERENCES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DONNEESREFERENCES actions', async () => {
      const arg = 42666;
