...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MATERIELS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MATERIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATERIEL actions', async () => {
      const arg = 42666;
