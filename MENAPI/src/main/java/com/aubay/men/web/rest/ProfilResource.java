...
import com.aubay.men.service.ProfilService;
...
/**
 * REST controller for managing {@link com.aubay.men.domain.Profil}.
 */
@RestController
...
public class ProfilResource {
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<ProfilDTO>> searchProfils(
